var textSource = {
    overLimit: 'But I must explain to you how all this mistaken idea of denouncing \
...
resultant pleasure? On the other hand, we denounce with righteous indignation \
...
pleasure? On the other hand, we denounce with righteous indignation and dislike \
...
all this mistaken idea of denouncin',
    underLimit: 'But I must explain to you how all this mistaken idea of denouncing \
pleasure and praising pain was born and I will give you a complete account of \
the system, and expound the actual teachings of the great explorer of the truth, \
the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure \
itself, because it is pleasure, but because those who do not know how to pursue \
...
this principle of selection: he rejects pleasures to secure other greater pleasures, \
or else he endures pains to avoid worse pains. But I must explain to you how \
all this mistaken idea of denounci'
};
